        ...
        <div className="row team-content-wrap">
          ...
          <div className="col-lg-3 col-sm-6">
            <div className="team-item team-item2">
              <div className="team__img">
                <img src="/images/team2.jpg" alt="person1" />
                <div className="team__img-links">
                  <ul>
                    <li>
                      <a href="twitter.com">
          ...
          <div className="col-lg-3 col-sm-6">
            <div className="team-item team-item3">
              <div className="team__img">
                <img src="/images/team3.jpg" alt="person" />
                <div className="team__img-links">
                  <ul>
                    <li>
                      <a href="/">
          ...
          <div className="col-lg-3 col-sm-6">
            <div className="team-item team-item4">
              <div className="team__img">
                <img src="/images/team4.jpg" alt="person" />
                <div className="team__img-links">
                  <ul>
                    <li>
                      <a href="/">
          ...
          <div className="col-lg-3 col-sm-6">
            <div className="team-item team-item1">
              <div className="team__img">
                <img src="/images/team5.jpg" alt="person" />
                <div className="team__img-links">
                  <ul>
                    <li>
                      <a href="/">
          ...
          <div className="col-lg-3 col-sm-6">
            <div className="team-item team-item2">
              <div className="team__img">
                <img src="/images/team6.jpg" alt="person" />
                <div className="team__img-links">
                  <ul>
                    <li>
                      <a href="/">
          ...
          <div className="col-lg-3 col-sm-6">
            <div className="team-item team-item3">
              <div className="team__img">
                <img src="/images/team7.jpg" alt="person" />
                <div className="team__img-links">
                  <ul>
                    <li>
                      <a href="/">
          ...
          <div className="col-lg-3 col-sm-6">
            <div className="team-item team-item4">
              <div className="team__img">
                <img src="/images/team8.jpg" alt="person" />
                <div className="team__img-links">
                  <ul>
                    <li>
                      <a href="/">
